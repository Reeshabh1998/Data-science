...
for i in range(1,21):
  ip=[]  
  url="https://www.amazon.in/Mi-Poco-64GB-Steel-Blue/product-reviews/B07H4X4F5Y/ref=cm_cr_getr_d_rvw_rvwer?pageNumber=1&reviewerType=avp_only_reviews"+str(i)
...
with open("D:\\360Digi\\Machine learning\\Text mining\\stop.txt","r") as sw:
    stop_words = sw.read()
    
stop_words = stop_words.split("\n")

stop_words.extend(["MI","mobile","tha","aur","pe","feet","bhi","don","time","life","android","phone","device","screen","battery","product","good","day","price"])
...
with open("D:\\360Digi\\Machine learning\\Text mining\\positive-words.txt","r") as pos:
  poswords = pos.read().split("\n")

stop_words.extend(["lover"])
...
with open("D:\\360Digi\\Machine learning\\Text mining\\negative-words.txt", "r") as neg:
...
WNL = nltk.WordNetLemmatizer()  # meanning full stem word
